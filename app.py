...
def register():
    ...
    sql="insert into patient(username,password,name,gender,height,weight,age,phoneNum,job,email) values('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s');"%(username,password,name,gender,height,weight,age,phoneNum,job,email)
...
def register_doctor():
    ...
    sql="insert into doctor(username,password,name,gender,workID,department,age,phoneNum,major,email) values('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s');"%(username,password,name,gender,workID,department,age,phoneNum,major,email)
    count_select=DB.update(sql)
    return jsonify('OK')
...
def test2():
    ...
    sql="update patients set Age='%s', HeartRate='%s' ,BloodPressure='%s', BloodSugar='%s',Cholesterol='%s' ,GlycerinTrihydrate='%s',UricAcid='%s',Platelet='%s', Glutopropase='%s' where Name='%s';" %(age,HeartRate,BloodPressure,BloodSugar,Cholesterol,GlycerinTrihydrate,UricAcid,Platelet,Glutopropase,name)
    DB.update(sql)
